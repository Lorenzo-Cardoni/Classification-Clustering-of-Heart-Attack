# AdaBoost Classifier senza Grid Search
'''
import pandas as pd
...
model = AdaBoostClassifier(n_estimators=50, random_state=42)  # Puoi regolare il numero di stimatori se necessario
